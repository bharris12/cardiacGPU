...
# if you want to make the parameter file include the constants for the model
...
for i in range(1,number_of_cables):
    ...
    for j in range(1,num_params):
        ...
        file_1D.write(str(rand_param_1)+ '\t') # writes value for the 1 cell in a cable
        file_2D.write(str(rand_param_1)+ '\t') # same first value in 1D and 2D cables
